...
internal static class PhotoLillian
{
    ...
    public static void AddDataMods()
    {
        ...
        var photoInfo = new SpriteInfoTexture(new TextureInfoExternal(Path.Combine(Plugin.ImagesDir, "photo_lillian_1.png")));

        var thumbInfo = new SpriteInfoTexture(new TextureInfoExternal(Path.Combine(Plugin.ImagesDir, "photo_lillian_1_thumb.png")));
