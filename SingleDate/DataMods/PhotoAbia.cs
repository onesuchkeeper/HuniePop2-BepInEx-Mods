...
internal static class PhotoAbia
{
    ...
    public static void AddDataMods()
    {
        ...
        var photoInfo = new SpriteInfoTexture(new TextureInfoExternal(Path.Combine(Plugin.IMAGES_DIR, "photo_abia_1.png"), true));

        var thumbInfo = new SpriteInfoTexture(new TextureInfoExternal(Path.Combine(Plugin.IMAGES_DIR, "photo_abia_1_thumb.png"), true));
