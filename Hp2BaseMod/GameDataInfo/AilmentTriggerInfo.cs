...
namespace Hp2BaseMod.GameDataInfo
{
    ...
    public class AilmentTriggerInfo : IGameDefinitionInfo<AilmentTriggerSubDefinition>
    {
        ...
        public List<IGameDefinitionInfo<AilmentStepSubDefinition>> StepInfos;
        ...
        public IEnumerable<string> GetInternalSpriteRequests() => StepInfos.OrEmptyIfNull()
            .SelectManyNN(x => x.GetInternalSpriteRequests());

        public IEnumerable<string> GetInternalAudioRequests() => StepInfos.OrEmptyIfNull()
